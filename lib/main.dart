...
class GaleriaDeImagenesApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(title: "No tiene efecto", debugShowCheckedModeBanner: false, home: new PaginaPrincipal(title: "GridView Galeria de fotos naranjo")); //Fin de materialApp
  } //Fin de widget
